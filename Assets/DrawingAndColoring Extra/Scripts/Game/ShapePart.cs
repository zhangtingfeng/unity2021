...
namespace IndieStudio.DrawingAndColoring.Logic
{
	...
	public class ShapePart : MonoBehaviour {
		...
		void Start () {
			...
			object previousColor = Area.shapesDrawingContents [ShapesManagerDraw.instance.lastSelectedShape].shapePartsColors [name];
			...
			object previousSortingOrder = Area.shapesDrawingContents [ShapesManagerDraw.instance.lastSelectedShape].shapePartsSortingOrder [name];
