...
namespace IndieStudio.DrawingAndColoring.Utility
{
	public class CommonUtilDraw
	{
		...
		public static int ShapeStarsNumberEnumToIntNumber (TableShapeDraw.StarsNumber starsNumber)
		{
			if (starsNumber == TableShapeDraw.StarsNumber.ZERO) {
				return 0;
			} else if (starsNumber == TableShapeDraw.StarsNumber.ONE) {
				return 1;
			} else if (starsNumber == TableShapeDraw.StarsNumber.TWO) {
				return 2;
			} else if (starsNumber == TableShapeDraw.StarsNumber.THREE) {
				return 3;
			}
		...
		public static TableShapeDraw.StarsNumber IntNumberToShapeStarsNumberEnum (int starsNumber)
		{
			if (starsNumber == 1) {
				return TableShapeDraw.StarsNumber.ONE;
			} else if (starsNumber == 2) {
				return TableShapeDraw.StarsNumber.TWO;
			} else if (starsNumber == 3) {
				return TableShapeDraw.StarsNumber.THREE;
			} else {
				return TableShapeDraw.StarsNumber.ZERO;
			}
		}
