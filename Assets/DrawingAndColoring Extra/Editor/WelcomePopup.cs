...
namespace IndieStudio.DrawingAndColoring.DCEditor
{
    ...
    public class WelcomePopup : EditorWindow
    {
        ...
        {
            initilized = false;
            PlayerPrefs.SetInt(strKey, CommonUtilDraw.TrueFalseBoolToZeroOne(false));
            Init();
        }
        ...
        private static void Init()
        {
            ...
            {
                dontShowWeclomeMessageAgain = CommonUtilDraw.ZeroOneToTrueFalseBool(PlayerPrefs.GetInt(strKey));
            }
            ...
            PlayerPrefs.SetInt(strKey, CommonUtilDraw.TrueFalseBoolToZeroOne(true));
        }
