...
{
    [CustomEditor(typeof(ShapesManagerDraw))]
    public class ShapesManagerEditor : Editor
    {
        ...
        {
            ShapesManagerDraw shapesManager = (ShapesManagerDraw)target;//get the target
            ...
            {
                shapesManager.shapes.Add(new ShapesManagerDraw.Shape());
            }
