...
namespace RenderHeads.Media.AVProVideo.Demos
{
    ...
    public class VCR : MonoBehaviour
    {
        ...
        private string[] _videoFiles = { Assets.Script.PunPinYin.StaticGlobal.ScanObjectPngName + "Video.mp4" };
        ...
        public void OnOpenVideoFile()
        {
            ...
            else
            {
                ...
                string strMP4Path = Assets.Script.PunPinYin.StaticGlobal.playVideoSetMp4Path;

                //LoadingPlayer.OpenVideoFromFile(_location, LoadingPlayer.m_VideoPath, _AutoStartToggle.isOn);
                LoadingPlayer.OpenVideoFromFile(_location, strMP4Path, _AutoStartToggle.isOn);
        ...
        public void OnStopButton()
        {
            ...
            //				SetButtonEnabled( "PlayButton", true );
            //}
            if (Assets.Script.PunPinYin.StaticGlobal.SelectDestinationTargetItem == "08Pronunce") {
                UnityEngine.SceneManagement.SceneManager.LoadScene("Scence/Sub/SoundModel");
            }
            else {
                UnityEngine.SceneManagement.SceneManager.LoadScene("Scence/Sub/VideoPlay");
            }
        }
