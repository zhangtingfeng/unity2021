...
public class AnimationManager : MonoBehaviour
{
    ...
    public void OnFinished()
    {
        ...
        if (name == "MenuPause")
        {
            if (LevelManager.THIS.gameStatus == GameStateGarden.Playing)
                LevelManager.THIS.gameStatus = GameStateGarden.Pause;
        }
        ...
        {
            CloseMenu();
            LevelManager.THIS.gameStatus = GameStateGarden.WaitForPopup;

        }
        if (name == "PreFailed")
        {
            if (LevelManager.THIS.Limit <= 0)
                LevelManager.THIS.gameStatus = GameStateGarden.GameOver;
            transform.Find("Video").gameObject.SetActive(false);
    ...
    public void CloseMenu()
    {
        ...
        {
            LevelManager.THIS.gameStatus = GameStateGarden.Map;
            //2.1
        ...
        if (SceneManager.GetActiveScene().name == "gameJellyGarden")
        {
            if (LevelManager.Instance.gameStatus == GameStateGarden.Pause)
            {
                LevelManager.Instance.gameStatus = GameStateGarden.WaitAfterClose;
    ...
    public void Play()
    {
        ...
        {
            CloseMenu();
            LevelManager.Instance.gameStatus = GameStateGarden.Playing;
        }
    }
    ...
    public void GoOnFailed()
    {
        ...
        LevelManager.THIS.gameStatus = GameStateGarden.Playing;
    }
