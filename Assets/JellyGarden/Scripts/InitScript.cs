...
public class InitScript : MonoBehaviour {
	...
	void Awake () {
		...
		int dddd = PlayerPrefs.GetInt("Lauched");
		int dddd1111 = PlayerPrefs.GetInt("Laeeeuched");
	...
	public void CheckAdsEvents (GameStateGarden state) {    //1.4 added
		foreach (AdEvents item in adsEvents) {
			if (item.gameEvent == state) {
				//1.5   1.6.1
//				if ((LevelManager.THIS.gameStatus == GameStateGarden.GameOver || LevelManager.THIS.gameStatus == GameStateGarden.Pause ||
//				    LevelManager.THIS.gameStatus == GameStateGarden.Playing || LevelManager.THIS.gameStatus == GameStateGarden.PrepareGame || LevelManager.THIS.gameStatus == GameStateGarden.PreWinAnimations ||
//				    LevelManager.THIS.gameStatus == GameStateGarden.RegenLevel || LevelManager.THIS.gameStatus == GameStateGarden.Win)) {
