...
namespace IndieStudio.LetterWrite.Utility
{
	...
	public class WelcomePopup : EditorWindow
	{
		...
		{
			initilized = false;
			PlayerPrefs.SetInt(strKey, CommonUtilLetter.TrueFalseBoolToZeroOne(false));
			Init();
		}
		...
		private static void Init()
		{
			...
			{
				dontShowWeclomeMessageAgain = CommonUtilLetter.ZeroOneToTrueFalseBool(PlayerPrefs.GetInt(strKey));
			}
			...
			PlayerPrefs.SetInt(strKey, CommonUtilLetter.TrueFalseBoolToZeroOne(true));
		}
