...
public class VideoPlayButton : Assets.Scripts.PunPinYin.pubButton
{
    ...
    void Start()
    {
        ...
        myButtonSelctList[1] = new ButtonSelect { buttonName = "PlaySound", left = 906, top = intFisrtTop, width = 77, playSound = false };
        myButtonSelctList[2] = new ButtonSelect { buttonName = "Pre", left = 906, top = intFisrtTop + intStep * 1, width = 77, playSound = false };
        myButtonSelctList[3] = new ButtonSelect { buttonName = "Next", left = 906, top = intFisrtTop + intStep * 2, width = 77, playSound = false };
        //myButtonSelctList[4] = new ButtonSelect { buttonName = "Record", left = 906, top = intFisrtTop + intStep * 3, width = 77, playSound = false };
        //myButtonSelctList[5] = new ButtonSelect { buttonName = "RecordStop", left = 906, top = intFisrtTop + intStep * 4, width = 77, playSound = false };
        //myButtonSelctList[6] = new ButtonSelect { buttonName = "RecordPlaySound", left = 906, top = intFisrtTop + intStep * 5, width = 77, playSound = false };
